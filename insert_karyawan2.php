    ...
    <h1><img src="images/apotek.png" alt="" width="397" height="121"></h1>
      <nav>
        <ul class="menu">
          ...
          <li><a class="active" href="lihat_karyawan.php">Our Employee</a></li>
...
<body>
<center>
<h3><font color="#00CCFF">Masukkan Data Karyawan Baru</font></h3>
</center>
<br></br>
<center>
...
<table width="300" border="0" cellpadding="5" cellspacing="2">
	<tbody>
    	<tr>
			<td>ID Karyawan</td>
            <td>:</td> 
            <td><input type="text" name="ID_Karyawan" maxlength="20" required /></td>
        </tr>
        <tr>
			<td>Nama Depan</td>
            <td>:</td>	
        ...
        <tr>
         ...
         <tr>
			<td>Status</td>
            <td>:</td>
            <td><input type="text" name="Status" maxlength="20" required /></td>
          </tr>
		  <tr>
			<td>No Telepon</td>
            <td>:</td>
