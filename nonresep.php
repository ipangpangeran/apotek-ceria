<?php
include "konek.php";
require "headerobat1.html";

$result = mysql_query("SELECT * FROM Obat WHERE ID_Obat LIKE 'N%' ORDER BY ID_Obat");
echo"<center><h3><font style='font-weight:bold;' font size='+5' font color='#00CCFF'>Obat Nonresep</font></h3></center>";
echo"<br></br>";
echo "<center>
<table style='border-style:dotted' width = '1020' border='1px' align='center'>
<tr align='center'>
<td width=9% font style='font-weight:bold;'>ID Obat</td>
<td width=18% font style='font-weight:bold;'>Nama</td>
<td width=5% font style='font-weight:bold;'>Jenis</td>
...
while($row = mysql_fetch_array($result))
  ...
  ?>
  <td width="60px"><button type="submit" name="Update" align="center"> <a href="update_nonresep.php?ID_Obat=<?php echo $row['ID_Obat']?>">Update</a></button></td> 
  <td width="60px"><button type="submit" name="Hapus" align="center"> <a href="delete_nonresep.php?ID_Obat=<?php echo $row['ID_Obat']?>" onClick="return confirm('Apakah Anda yakin akan menghapus obat nonresep?')">Hapus</a></button></td> 
  <?php
  echo "</tr>";
